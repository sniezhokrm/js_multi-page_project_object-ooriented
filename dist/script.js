...
window.addEventListener('DOMContentLoaded', function () {
  ...
  player.init();
  var showUpSlider = new _modules_sliders_miniSlider__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_sliders_miniSlider__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_sliders_miniSlider__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('.schedule__form').init();
});
  ...
  _createClass(Forms, [{
    ...
    value: function init() {
      ...
      this.form.addEventListener('submit', function (e) {
        ...
        _this.form.parentNode.appendChild(statusMessage);

        _this.form.classList.add('animated', 'fadeOutUp');
        ...
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_4__["postData"])(path, formData).then(function (res) {
          console.log(res);
          ...
          setTimeout(function () {
            ...
            _this.form.classList.remove('fadeOutUp');
    ...
    value: function showSlides(n) {
      ...
      try {
        ...
        if (n == 3) {
          ...
          setTimeout(function () {
            _this.hanson.style.bottom = '80px';
